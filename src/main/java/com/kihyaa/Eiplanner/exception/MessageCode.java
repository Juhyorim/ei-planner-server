...
public class MessageCode {
    public static final String SUCCESS_CREATE_RESOURCE = "리소스 생성을 성공했습니다.";
    public static final String SUCCESS_DELETE_RESOURCE = "리소스 삭제를 성공했습니다.";
    public static final String SUCCESS_UPDATE_RESOURCE = "리소스 갱신을 성공했습니다.";
    public static final String SUCCESS_BUT_NOTHING_HAPPENDED = "성공했지만 리소스의 변화가 없습니다";
